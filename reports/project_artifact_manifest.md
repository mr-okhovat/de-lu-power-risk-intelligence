...
|---|---|---:|---:|---:|---|
| project | `README.md` | True | True | 5617 | `f3758bc75b67` |
...
| reviewer | `reports/senior_reviewer_note.md` | True | True | 1726 | `79c7aeb75412` |
...
| dashboard | `app/streamlit_app.py` | True | True | 33126 | `5c0db3ed540a` |
