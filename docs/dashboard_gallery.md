...
The dashboard screenshots show the current local analyst app.
...
This is a local analyst dashboard for reviewing already-built outputs.

It is not a production web app, trading system, price forecast, or P&L tool.
